;;; default-black-theme.el --- Based on TextMate Blackboard Theme
...
(custom-theme-set-faces
 ...
 `(which-func ((t (:bold t :foreground "black"))))
...
;; `(org-block ((t (:foreground "White" :background "#333333"))))
